...
<div class="top">
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="/FindCommodity?id=3">水果类</a>
            <a href="/FindCommodity?id=5">海产类</a>
            <a href="/FindCommodity?id=6">鲜花类</a>
            <a href="/FindCommodity?id=8">蔬菜类</a>
...
<div class="banner ma" id="pics">
    ...
    <ul>
        <li><a href=""><img class="img01" src="./imgs/top1.jpg"></a></li>
        <li><a href=""><img class="img01" src="./imgs/top2.jpg"></a></li>
        <li><a href=""><img class="img01" src="./imgs/top3.png"></a></li>
        <li><a href=""><img class="img01" src="./imgs/top2.jpg"></a></li>
        <li><a href=""><img class="img01" src="./imgs/top3.png"></a></li>
    </ul>
</div>
